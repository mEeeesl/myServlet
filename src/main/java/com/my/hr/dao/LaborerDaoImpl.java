...
public class LaborerDaoImpl implements LaborerDao {
	...
	@Override
	public void insertLaborer(String name, LocalDate hireDate) {
		laborerMap.insertLaborer(name, hireDate);
	}
	...
	@Override
	public void deleteLaborer(int laboerId) {
		laborerMap.deleteLaborer(laboerId);
	}
}
